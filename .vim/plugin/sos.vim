...
map <silent> <Leader>a :call <SID>sosCreate()<CR>
map <silent> <Leader>o :call <SID>sosCheckOut()<CR>
map <silent> <Leader>i :call <SID>sosCheckIn()<CR>
map <silent> <Leader>d :call <SID>sosDiscardCO()<CR>
map <silent> <Leader>u :call <SID>sosUpdateFile()<CR>
...
function s:sosHelp()
    ...
    \ "a - Create a file in SOS\n" .
    \ "o - Check out a file\n" .
    \ "i - Check in a file\n" .
    \ "d - Discard check out of file\n" .
    \ "u - Update file\n" .
    \ "s - Invoke sos gui\n" .
    \ "\n" .
    \ "Default <Leader> is \\" .
